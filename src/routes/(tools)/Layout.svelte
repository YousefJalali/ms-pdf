<script lang="ts">
	...
	$: showPages = path === LINKS.merge ? false : true
</script>
...
{:else}
	<div class="flex gap-8 w-full">
		...
		<div
			class="peer lg:flex-[0_0_30%] flex w-full border bg-base-100 flex-col rounded-2xl p-4 fixed bottom-0 left-0 z-20 lg:relative"
			data-testid="side"
		>
