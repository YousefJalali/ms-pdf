export const translations = {
	en: {
		'pdfToImage.upload.title': 'Convert Your PDFs to Images Effortlessly!',
		...
		'pdfToImage.uploading.title': 'Uploading Your PDFs...',
		...
		'pdfToImage.merged.title': '🎉 Your PDFs Have Been Merged!',
		...
		'pdfToImage.downloading.title': '⏳ Preparing Your Download Link...',
		...
		'pdfToImage.downloaded.title': 'Woohoo! Download Successful! 🎉',
		...
		'merge.upload.title': 'Merge Your PDFs Seamlessly!',
		...
		'merge.uploading.title': 'Uploading Your PDFs...',
		...
		'merge.merging.title': 'Merging Your PDFs...',
		...
		'merge.merged.title': '🎉 Your PDFs Have Been Merged!',
		'merge.merged.description':
			'Your PDF files have been successfully combined into a single document. You can preview the merged PDF below.',
		'merge.downloading.title': '⏳ Preparing Your Download Link...',
		...
		'merge.downloaded.title': '✅ Download Complete!',
		...
		'split.upload.title': 'Split Your PDF Easily!',
		...
		'split.uploading.title': 'Uploading Your PDF...',
		...
		'split.splitting.title': 'Splitting Your PDF...',
		...
		'split.split.title': '🎉 Your PDF Has Been Split!',
		...
		'split.downloading.title': '⏳ Preparing Your Download Links...',
